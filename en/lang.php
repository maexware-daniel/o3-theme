...
$aLang = [
    ...
    'O3_FORM_VALIDATION_PASSWORD_LENGTH'                    => 'The password must be <strong>at least %s characters</strong> long, ',
    'O3_FORM_VALIDATION_PASSWORD_LETTERS'                   => 'contain at least one <strong>upper case letter</strong>, at least one <strong>lower case letter</strong>, at least one <strong>number</strong> and at least one <strong>special character</strong>(@$!%*?&).',
