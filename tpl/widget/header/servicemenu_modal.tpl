...
<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modal__account" aria-controls="modal__account">
...
<div class="modal fade" id="modal__account" tabindex="-1" aria-labelledby="modal__account" aria-hidden="true">
            ...
            <div class="modal-body">
                [{block name="dd_layout_page_header_icon_menu_account_list"}]
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#tab__login">
                                [{oxmultilang ident="LOGIN"}]
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#tab__register">
                                [{oxmultilang ident="REGISTER"}]
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab__login">
                            [{if !$oxcmp_user}]
                        ...
                        <div class="tab-pane" id="tab__register">
                            Tab 2 selected
                        </div>
                    </div>
                [{/block}]
